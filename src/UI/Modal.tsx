...
const UIModal: React.FC<TypeModalProps> = ({
	...
	const twClasses = {
		modalContainer: `${context.theme.current} fixed top-0 left-0 z-[500] w-screen h-screen bg-gray-800/30`,
		centeredContent: `flex w-full h-screen justify-center items-center ${paddingVal}`,
	}
