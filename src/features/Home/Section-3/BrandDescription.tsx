...
export default function Section3_BrandDescription(){
	...
	return (
		<p className={twClass}>
			Fancydo is Dominic Pam showcase of Front End Stack Technology mainly{" "}
			<HW>React</HW>, <HW>React Router</HW>, <HW>Tanstack</HW>, and using
			Supabase as backend service. As other library for UI such as{" "}
			<HW>React Icons</HW>, <HW>Tailwind</HW> and <HW>Framer Motion</HW>
		</p>
	)
}